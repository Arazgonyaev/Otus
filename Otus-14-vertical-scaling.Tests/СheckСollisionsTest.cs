...
public class СheckСollisionsTest
{
    ...
    public void NoCollision_SmallObjects()
    {
        ...
        var field = new Game2DField(100, 100);
        ...
        var checker = new SimpleCollisionChecker(1, logger); // small objects
        var resetEvent = new ManualResetEvent(false);
        
        queue.Add(new MoveCommand(ship1));
    ...
    public void Collision_TheSamePosition()
    {
        ...
        var log = new List<string>();
        var logger = new ListLogger(log);
        var checker = new SimpleCollisionChecker(5, logger);
        var resetEvent = new ManualResetEvent(false);
    ...
    public void Collision_DifferentArea_TwoAreaSystems()
    {
        ...
        var field1 = new Game2DField(100, 100);
        field1.AddObject(ship1);
        field1.AddObject(ship2);
        var field2 = new Game2DField(100, 100, areaDelta: 5); // вторая система окрестностей со смещением
